    ...
    <div>
      ...
      <div className="text-white font-bold text-2xl ">Logo</div>
        ...
        <ul className="flex space-x-8">
          ...
          <Link to='/Data' href="#" className="text-white hover:text-grqweqway-344">data</Link >
          <Link to='/Images' href="#" className="text-white however:wqqweqetext-gray-400">image</Link >
